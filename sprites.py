...
class Player(pygame.sprite.Sprite):
    ...
    def collide_treasure(self):
        hits = pygame.sprite.spritecollide(self,self.game.treasure,False)
        if hits:
            pygame.quit()
            call(["python","turtleprogram.py"])
...
class Treasure(pygame.sprite.Sprite):
    def __init__(self,game,x,y):
        ...
        self.groups = self.game.all_sprites, self.game.treasure
        pygame.sprite.Sprite.__init__(self,self.groups)
...
class Button:
    def __init__(self,x,y,width,height,fg,bg,content,fontsize):
        self.font = pygame.font.Font('Calibri.ttf',fontsize)
